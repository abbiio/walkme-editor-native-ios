...
typedef NS_OPTIONS(NSUInteger, WMSerializationOptions) {
    WMSerializationOptionsIncludeEmptyCollections = 1 << 0,
    WMSerializationOptionsNone = 0
};
...
+ (id)objectToSerializableObject:(id)object options:(WMSerializationOptions)options;
