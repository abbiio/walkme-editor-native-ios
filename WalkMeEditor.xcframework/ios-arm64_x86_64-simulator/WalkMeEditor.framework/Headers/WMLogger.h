...
#define __WM__FILE_NAME__ [[[NSString stringWithUTF8String:__FILE__] lastPathComponent] UTF8String]
...
typedef NS_ENUM(NSUInteger, WMCommonLoggerMode) {
    WMCommonLoggerModeNone = 0,
    WMCommonLoggerModeStdout = (1 << 0), // 00000001
    WMCommonLoggerModeFile = (1 << 1), // 00000010,
    WMCommonLoggerModeWalkme = (1 << 2), // 00000100. curently not supported
};
...
+ (void)setLogMode:(WMCommonLoggerMode)mode;
